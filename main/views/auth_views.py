...
def home(request):
    """Home page view."""
    from main.models import Job, TeamMember, HeroPhoto
    ...
    # Get active hero photos for the gallery
    hero_photos = HeroPhoto.objects.filter(is_active=True).order_by('display_order', 'id')
